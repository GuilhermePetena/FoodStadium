...
const rotaClienteLocalSetorBloco = require('./routes/cliente-local-setor-bloco')
const rotaEntregadorLocalSetor = require('./routes/entregador-local-setor')
const rotaRestauranteLocalSetor = require('./routes/restaurante-local-setor')
...
app.use('/cliente-local-setor-bloco', rotaClienteLocalSetorBloco)
app.use('/entregador-local-setor', rotaEntregadorLocalSetor)
app.use('/restaurante-local-setor', rotaRestauranteLocalSetor)
