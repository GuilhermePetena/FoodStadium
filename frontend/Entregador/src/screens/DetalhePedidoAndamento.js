...
export default class DetalhePedidoAndamento extends Component {
        ...
        return(
            <ScrollView>
                ...
                <View style={styles.viewStatus}>
                    ...
                    <Text style={styles.txtStatus}>Nome do Restaurante</Text>
                    <Text style={styles.txtStatus}>Nome do Cliente</Text>
                ...
                <View style={styles.viewBtn}>
                  <Button style={styles.buttonFinalizar} mode= 'contained'>
                      Finalizar Pedido
                  </Button>
                </View>
                <View style={styles.viewBtn}>
                  <Button style={styles.buttonCancelar} mode= 'contained'>
                      Cancelar
                  </Button>
                </View>
            </ScrollView> 
