...
export default class DetalhePedidoRealizado extends Component {
        ...
        return(
            <ScrollView>
                ...
                <View style={styles.viewStatus}>
                    ...
                    <Text style={styles.txtStatus}>Restaurante: </Text>
                    <Text style={styles.txtStatus}>Nome cliente: </Text>
                    <Text style={styles.txtStatus}>Forma de Pagamento: </Text>
                    <Text style={styles.txtStatus}>Data: 29/06/2020</Text>
