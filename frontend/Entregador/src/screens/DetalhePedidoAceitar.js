...
export default class DetalhePedidoAceitar extends Component {
        ...
        return(
            <ScrollView>
                ...
                <View style={styles.viewStatus}>
                    ...
                    <Text style={styles.txtStatus}>Nome restaurante</Text>
                    <Text style={styles.txtStatus}>Nome cliente</Text>
