          ...
          <ScrollView>
            <View style={styles.background}>
                ...
                <View style={styles.viewText}>
                        <TextInput style={styles.text} underlineColor="#F2A22C" selectionColor="#F2A22C" label="Banco"/>
                    </View>
                    <View style={styles.viewText}>
                        <TextInput style={styles.text} underlineColor="#F2A22C" selectionColor="#F2A22C" label="Agência"/>
                    </View>
                    <View style={styles.viewText}>
                        <TextInput style={styles.text} underlineColor="#F2A22C" selectionColor="#F2A22C" label="Conta"/>
                    </View>
                    <View style={styles.viewText}>
